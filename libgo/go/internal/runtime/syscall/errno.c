...
uintptr_t getErrno(void) __asm__ (GOSYM_PREFIX "internal_1runtime_1syscall.getErrno");
void setErrno(uintptr_t) __asm__ (GOSYM_PREFIX "internal_1runtime_1syscall.setErrno");
