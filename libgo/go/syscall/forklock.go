...
// This file provides the "fancy" ForkLock implementation for platforms
// where forkExecPipe is defined outside of forkpipe2.go (gccgo defines
// forkExecPipe for linux in exec_linux.go and for solaris in exec_bsd.go),
// so those platforms are excluded from forkpipe2.go and would otherwise
// have no definition of acquireForkLock/releaseForkLock.
